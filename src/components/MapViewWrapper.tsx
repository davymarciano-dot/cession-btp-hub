...
// Import dynamique de MapView pour éviter les problèmes de contexte
const MapView = lazy(() => import('./MapView').catch(() => ({
  default: () => <MapViewError />
})));
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: any) {
    ...
    // Notifier le composant parent de l'erreur
